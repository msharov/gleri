...
enum Feature : uint16_t {
    ...
    CAP_DITHER,
    CAP_COLOR_LOGIC_OP,
    CAP_FRAMEBUFFER_SRGB,
    CAP_LINE_SMOOTH,
    CAP_POLYGON_OFFSET_FILL,
    CAP_POLYGON_OFFSET_LINE,
    CAP_POLYGON_OFFSET_POINT,
    CAP_POLYGON_SMOOTH,
    CAP_PRIMITIVE_RESTART,
    CAP_PRIMITIVE_RESTART_FIXED_INDEX,
    CAP_RASTERIZER_DISCARD,
    CAP_SAMPLE_ALPHA_TO_COVERAGE,
    CAP_SAMPLE_ALPHA_TO_ONE,
    CAP_SAMPLE_COVERAGE,
    CAP_SAMPLE_SHADING,
    CAP_SAMPLE_MASK,
    CAP_SCISSOR_TEST,
    CAP_STENCIL_TEST,
    CAP_TEXTURE_CUBE_MAP_SEAMLESS,
    CAP_PROGRAM_POINT_SIZE,
    CAP_N
};
